...
class PendidikanController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ...
            ->with('success', 'Data pendidikan tersimpan. Silakan tambahkan data pendidikan lainnya atau klik Simpan untuk lanjut.');
    }
    ...
    public function update(Request $request, PendidikanPegawai $pendidikan_pegawai): RedirectResponse
    {
        ...
        return redirect()
            ->route('pegawai.show', ['pegawai' => $pegawai, 'tab' => 'pendidikan'])
